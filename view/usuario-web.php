...
<head>
    ...
    <title>Despacho HC - usuario</title>
</head>
...
<body>
    ...
    <h1>Bienvenido</h1>
        ...
        <div class="datos-usuario">
            <div class="tabla__titulo--usuariosweb">Mis datos</div>
            ...
            ?>
                ...
                <input type="password" class="tabla__item" value="<?php echo $row['contrasena'];?>">
                <div class="tabla__item">
                    <a href="update-usuario-web.php?id=<?php echo $row["idUsuarioWeb"];?>"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit btn-animated" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <p> - </p>
                    <a href="../model/delete-usuario-web.php?id=<?php echo $row["idUsuarioWeb"];?>" class="btn-eliminar btn-animated"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
